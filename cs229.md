...
$$p(x; \mu, \Sigma) = \frac{e^{-\frac{(x - \mu)^T\Sigma^{-1}(x - \mu)}{2}}}{(2\pi)^{\frac{d}{2}}|\Sigma|^{\frac{1}{2}}}$$
...
如果改成$\left[\begin{matrix} 1 & 0.8 \\ 0.8 & 1 \end{matrix}\right]$ 会变得又尖又扁，也就是说 $z_1, z_2$ 更加的正相关
